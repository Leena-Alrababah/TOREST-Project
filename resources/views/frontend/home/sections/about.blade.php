            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="{{ asset('frontend/img2/restresrvbild3.webp')}}" alt="" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">About Us</h6>
                    <h1 class="mb-4">Welcome to <span class="text-primary">TOREST</span></h1>
                    <p class="mb-4">Our community is built on trust. Whether you’re a consumer or a destination owner, you put your trust in us to provide information people can rely on to make good decisions.
                     We work hard to maintain that trust, and make TOREST truly helpful for everyone.</p>
