   <!-- Service Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Why Choose TOREST?</h1>
            </div>
            <div class="row g-4">
    ...
    <div class="service-item rounded pt-3 custom-height">
        <div class="p-4">
            ...
            <h5>Discounted Reservations</h5>
            <p>We provide a discount percentage for reservations made at our restaurants. Take advantage of our special offers when you book your table in advance!</p>
        </div>
    </div>
</div>
